...
Inform the user they may "transition" into a new dreamscape if the current one becomes too intense or frightening.
Invite the user to "submerge" into the dreamscape by saying "I'm ready to submerge into the dreamscape."
`;